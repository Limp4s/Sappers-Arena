...
const DICTS = {
  en: {
    ...
    admin: { title: 'OWNER', ownerTitle: 'FOUNDER', adminTitle: 'ADMIN', promote: 'PROMOTE TO ADMIN', grantBtn: 'GRANT',
      ...
      promoted: 'promoted.',
      demote: 'TAKE ADMIN', demoteConfirm: 'Remove admin rights from {nickname}?', demoted: '{nickname} demoted.',
  ...
  ru: {
    ...
    admin: { title: 'ВЛАДЕЛЕЦ', ownerTitle: 'ОСНОВАТЕЛЬ', adminTitle: 'АДМИН', promote: 'СДЕЛАТЬ АДМИНОМ', grantBtn: 'ВЫДАТЬ',
      ...
      promoted: 'повышен.',
      demote: 'ЗАБРАТЬ АДМИНКУ', demoteConfirm: 'Забрать админку у {nickname}?', demoted: '{nickname} разжалован.',
  ...
  uk: {
    ...
    achievements: {
      ...
      items: {
        ...
        collect_mines_all: { title: 'КОЛЕКЦІОНЕР МІН', cond: 'Зібрати всі скіни мін', desc: 'Збери всі скіни мін у магазині.' },
        collect_cells_all: { title: 'КОЛЕКЦІОНЕР КЛІТИНОК', cond: 'Зібрати всі скіни клітинок', desc: 'Збери всі скіни клітинок у магазині.' },
        collect_fx_all: { title: 'КОЛЕКЦІОНЕР ЕФЕКТІВ', cond: 'Зібрати всі ефекти вибуху', desc: 'Збери всі ефекти вибуху у магазині.' },
        collect_flags_all: { title: 'КОЛЕКЦІОНЕР ПРАПОРЦІВ', cond: 'Зібрати всі скіни прапорців', desc: 'Збери всі скіни прапорців у магазині.' },
        collect_shop_all: { title: 'СПРАВЖНІЙ КОЛЕКЦІОНЕР', cond: 'Зібрати всі предмети', desc: 'Збери всі предмети в магазині.' },
    ...
    admin: { title: 'ВЛАСНИК', ownerTitle: 'ЗАСНОВНИК', adminTitle: 'АДМІН', promote: 'ЗРОБИТИ АДМІНОМ', grantBtn: 'НАДАТИ',
      ...
      promoted: 'призначено.',
      demote: 'ЗАБРАТИ АДМІНКУ', demoteConfirm: 'Забрати адмінку у {nickname}?', demoted: '{nickname} розжалувано.',
      processing: 'ОБРОБКА...',
  ...
  cs: {
    ...
    achievements: {
      ...
      items: {
        ...
        collect_mines_all: { title: 'SBĚRATEL MIN', cond: 'Seber všechny skiny min', desc: 'Seber všechny skiny min v obchodě.' },
        collect_cells_all: { title: 'SBĚRATEL BUNĚK', cond: 'Seber všechny skiny buněk', desc: 'Seber všechny skiny buněk v obchodě.' },
        collect_fx_all: { title: 'SBĚRATEL EFEKTŮ', cond: 'Seber všechny efekty výbuchu', desc: 'Seber všechny efekty výbuchu v obchodě.' },
        collect_flags_all: { title: 'SBĚRATEL VLAJEK', cond: 'Seber všechny skiny vlajek', desc: 'Seber všechny skiny vlajek v obchodě.' },
        collect_shop_all: { title: 'PRAVÝ SBĚRATEL', cond: 'Seber všechny předměty', desc: 'Seber všechny předměty v obchodě.' },
    ...
    admin: { title: 'VLASTNÍK', ownerTitle: 'ZAKLADATEL', adminTitle: 'ADMIN', promote: 'POVÝŠIT NA ADMINA', grantBtn: 'UDĚLIT',
      ...
      promoted: 'povýšen.',
      demote: 'ODEBRAT ADMINA', demoteConfirm: 'Odebrat admin práva hráči {nickname}?', demoted: '{nickname} byl odebrán admin.',
  ...
  es: {
    ...
    achievements: {
      ...
      items: {
        ...
        collect_mines_all: { title: 'COLECCIONISTA DE MINAS', cond: 'Colecciona todas las skins de minas', desc: 'Consigue todas las skins de minas en la tienda.' },
        collect_cells_all: { title: 'COLECCIONISTA DE CELDAS', cond: 'Colecciona todas las skins de celdas', desc: 'Consigue todas las skins de celdas en la tienda.' },
        collect_fx_all: { title: 'COLECCIONISTA DE FX', cond: 'Colecciona todos los efectos de explosión', desc: 'Consigue todos los efectos de explosión en la tienda.' },
        collect_flags_all: { title: 'COLECCIONISTA DE BANDERAS', cond: 'Colecciona todas las skins de banderas', desc: 'Consigue todas las skins de banderas en la tienda.' },
        collect_shop_all: { title: 'COLECCIONISTA TOTAL', cond: 'Colecciona todos los objetos', desc: 'Consigue todos los objetos disponibles en la tienda.' },
    ...
    admin: { title: 'DUEÑO', ownerTitle: 'FUNDADOR', adminTitle: 'ADMIN', promote: 'ASCENDER A ADMIN', grantBtn: 'DAR',
      ...
      promoted: 'ascendido.',
      demote: 'QUITAR ADMIN', demoteConfirm: '¿Quitar admin a {nickname}?', demoted: '{nickname} degradado.',
...
_setPath(DICTS.fr, 'admin.demote', 'RETIRER ADMIN');
_setPath(DICTS.fr, 'admin.demoteConfirm', 'Retirer le rôle admin de {nickname} ?');
_setPath(DICTS.fr, 'admin.demoted', '{nickname} rétrogradé.');
...
_setPath(DICTS.de, 'admin.demote', 'ADMIN ENTFERNEN');
_setPath(DICTS.de, 'admin.demoteConfirm', 'Admin-Rechte von {nickname} entfernen?');
_setPath(DICTS.de, 'admin.demoted', '{nickname} herabgestuft.');
...
_setPath(DICTS.zh, 'admin.demote', '取消管理员');
_setPath(DICTS.zh, 'admin.demoteConfirm', '取消 {nickname} 的管理员权限？');
_setPath(DICTS.zh, 'admin.demoted', '{nickname} 已被降级。');
