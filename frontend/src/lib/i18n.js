...
const DICTS = {
  ...
  uk: {
    ...
    game: {
      ...
      minesLower: 'мін',
      livesLower: 'життів',
      controlsHint: '// ЛКМ відкрити  ·  ПКМ прапор  ·  перший клік безпечний',
      time: 'ЧАС',
      mines: 'МІНИ',
      score: 'РАХУНОК',
      lives: 'ЖИТТЯ',
    ...
    leaderboard: {
      topRanked: 'Топ рейтинг',
      noRankedRunsYet: 'поки немає рангових забігів.',
      agentStats: 'Статистика агента',
      callsignPlaceholder: 'позивний...',
      scan: 'СКАН',
      scanning: 'сканування...',
      enterCallsignHint: 'Введи позивний, щоб побачити статистику.',
      recentActivity: 'Остання активність',
      noRunsYet: 'поки немає забігів.',
    },
    profile: {
      inventory: 'ІНВЕНТАР',
      ...
      newPassword: 'Новий пароль · мін 4',
