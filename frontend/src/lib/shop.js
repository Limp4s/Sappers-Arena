...
export const MINE_ICONS = {
  ...
  mine_crown:      { icon: Crown,      name: 'Crown',       price: 5000 },
  mine_gem:        { icon: Gem,        name: 'Gem',         price: 4000 },
};
...
export const CELL_THEMES = {
  ...
  cell_silver: { name: 'Silver', price: 2000, accent: '#CBD5E1',
    number: { 1:'#E2E8F0', 2:'#CBD5E1', 3:'#94A3B8', 4:'#64748B', 5:'#475569', 6:'#CBD5E1', 7:'#ffffff', 8:'#94A3B8' } },
  cell_ice_premium: { name: 'Premium Ice', price: 4000, accent: 'ice_premium',
    number: { 1:'#A5F3FC', 2:'#67E8F9', 3:'#22D3EE', 4:'#38BDF8', 5:'#60A5FA', 6:'#A5F3FC', 7:'#ffffff', 8:'#94A3B8' } },
  cell_fire_premium: { name: 'Premium Flame', price: 4000, accent: 'fire_premium',
    number: { 1:'#FB923C', 2:'#F97316', 3:'#FBBF24', 4:'#FF2A6D', 5:'#EF4444', 6:'#FB923C', 7:'#ffffff', 8:'#94A3B8' } },
  ...
  cell_aurora: { name: 'Aurora', price: 3000, accent: '#00FF9D',
    number: { 1:'#00FF9D', 2:'#00E5FF', 3:'#A855F7', 4:'#FF2A6D', 5:'#FFD700', 6:'#22D3EE', 7:'#ffffff', 8:'#94A3B8' } },
  ...
  cell_rainbow_premium: { name: 'Rainbow', price: 5000, accent: 'rainbow',
...
export const FX_EFFECTS = {
  ...
  fx_silver: { name: 'Silver Burst', price: 2000, color: 'rgba(226, 232, 240, 0.55)' },
  fx_ice_premium: { name: 'Premium Ice', price: 4000, color: 'ice_premium' },
  fx_fire_premium: { name: 'Premium Flame', price: 4000, color: 'fire_premium' },
...
export const FLAG_SKINS = {
  ...
  flag_rainbow: { icon: Flag, name: 'Rainbow Flag', price: 2000, color: 'rainbow' },
};
