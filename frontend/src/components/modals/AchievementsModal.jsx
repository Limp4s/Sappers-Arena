...
export default function AchievementsModal({ open, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[90] flex items-center justify-center px-4 py-8" data-testid="achievements-modal">
      <div className="absolute inset-0 bg-black/70" onClick={onClose} />
      <div className="relative w-full max-w-[820px] max-h-[calc(100vh-64px)] glass-panel rounded-2xl border border-white/10 p-4 md:p-5 overflow-hidden">
        ...
        <div className="mt-4 overflow-auto pr-1" style={{ maxHeight: 'calc(100vh - 64px - 64px)' }}>
          {!defs || !mine ? (
